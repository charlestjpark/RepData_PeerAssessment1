...
```{r, label = '1-Frequency Distribution without Missing Values', echo=TRUE}
hist(data1$steps,
     col = "blue",
...
```{r, label = '2-Line Plot of Average Steps without Missing Values', echo=TRUE}
...
```{r, label = '3-Frequency Distribution with Imputations', echo=TRUE}
...
```{r, label = '4-Comparison of Average Steps by Interval between Weekday and Weekend', echo=TRUE}
