...
```{r, fig.path = 'figure/1-Frequency Distribution without Missing Values', label = 'Frequency Distribution of Number of Daily Steps', echo=TRUE}
hist(data1$steps,
     col = "blue",
...
```{r, fig.path = 'figure/2-Line Plot of Average Steps without Missing Values', echo=TRUE}
...
```{r, fig.path = 'figure/3-Frequency Distribution with Imputations', echo=TRUE}
...
```{r, fig.path = 'figure/4-Comparison of Average Steps by Interval between Weekday and Weekend', echo=TRUE}
